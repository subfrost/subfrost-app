...
import { lasereyesMiddleware } from "@/app/middleware";
      ...
      <Card className="frost-bg frost-border">
        <CardHeader>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <CardTitle className="retro-text text-blue-600 mb-4 md:mb-0">
              Wallet
            </CardTitle>
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 md:space-y-0 md:space-x-2">
              <Button
                onClick={handleDisconnect}
                className="retro-text text-xs bg-red-500 hover:bg-red-600"
              >
                Disconnect
              </Button>
              <Button
                onClick={handleSwitchWallet}
                className="retro-text text-xs bg-blue-500 hover:bg-blue-600"
              >
                Switch Wallet
              </Button>
            </div>
          ...
          <div className="bg-blue-900 bg-opacity-30 rounded-lg flex flex-col sm:flex-row">
            ...
            <div className="flex-grow p-4">
              <div className="flex flex-col space-y-2">
                <span className="retro-text text-xs text-blue-100">
                  Wallet Address
                </span>
                <div className="flex items-center space-x-2">
                  <span className="retro-text text-sm break-all bg-blue-800 bg-opacity-20 p-2 rounded">
                    {address}
                  </span>
