      ...
      <div className="mt-6 mx-auto w-full max-w-[320px] font-semibold">
        ...
        <div className="mt-8">
          <button
            ...
            className="w-full rounded-lg bg-[color:var(--sf-primary)] py-3 text-sm font-semibold tracking-wide text-white shadow-sm transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] hover:transition-none hover:brightness-110 disabled:opacity-60 disabled:cursor-not-allowed focus:outline-none"
          >
