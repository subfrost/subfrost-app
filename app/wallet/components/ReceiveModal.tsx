...
export default function ReceiveModal({ isOpen, onClose }: ReceiveModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="bg-[#1a1a1a] rounded-2xl border border-white/10 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <h2 className="text-2xl font-bold text-white">Receive Bitcoin</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm text-white/60">Your Bitcoin Address</label>
            <div className="flex items-center gap-2">
              <div className="flex-1 px-4 py-3 rounded-lg bg-white/5 border border-white/10 font-mono text-sm break-all">
                {address}
              </div>
              <button
                onClick={copyAddress}
          ...
          <div className="space-y-2">
            <label className="text-sm text-white/60">Bitcoin URI</label>
            <div className="px-4 py-3 rounded-lg bg-white/5 border border-white/10">
              <code className="text-xs break-all text-white/80">
                bitcoin:{address}
              </code>
            </div>
