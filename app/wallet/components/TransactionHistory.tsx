                  ...
                  <div className="flex items-center gap-2">
                    {!tx.confirmed && pendingHexByTxid.has(tx.txid) && walletType === 'keystore' && (
                      <button
                        ...
                        className="flex items-center gap-1 px-2 py-1 rounded text-xs font-bold uppercase tracking-wide bg-yellow-500/20 dark:bg-amber-500/20 hover:bg-yellow-500/30 dark:hover:bg-amber-500/30 text-yellow-600 dark:text-amber-300 transition-all"
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-bold ${
                        tx.confirmed
                          ...
                          : 'bg-yellow-500/20 dark:bg-amber-500/20 text-yellow-600 dark:text-amber-300'
                      }`}
                    >
