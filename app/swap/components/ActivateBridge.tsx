...
function Snowflake({
  ...
  return (
    <svg
      ...
      height="32"
      viewBox="0 0 256 256"
      className={`${colorClass} transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] hover:transition-none ${isRotating ? 'animate-spin' : ''}`}
...
export default function ActivateBridge({
  ...
  return (
    <div
      className={`overflow-hidden transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] ${
      ...
      <div className="rounded-xl bg-gradient-to-r from-[color:var(--sf-primary)] to-[color:var(--sf-primary-pressed)] p-[2px]">
        <div className="rounded-[10px] bg-[color:var(--sf-surface)] p-6">
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <button
              onClick={handleCopy}
              className="flex-shrink-0 p-2 rounded-lg border border-[color:var(--sf-outline)] bg-[color:var(--sf-surface)] hover:bg-[color:var(--sf-glass-bg)] transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)]"
          ...
          <div className="grid grid-cols-2 gap-y-10 md:gap-y-4 lg:gap-y-10">
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              />
              <span className={`text-xs font-semibold text-center transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] hover:transition-none ${getTextColorClass(1)}`}>
                1. {STEP_LABELS[1]}
              </span>
            </div>
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              />
              <span className={`text-xs font-semibold text-center transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] hover:transition-none ${getTextColorClass(2)}`}>
                2. {STEP_LABELS[2]}
              </span>
            </div>
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              />
              <span className={`text-xs font-semibold text-center transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] hover:transition-none ${getTextColorClass(3)}`}>
                3. {STEP_LABELS[3]}
              </span>
            </div>
            ...
            <div className="flex flex-col items-center gap-1">
              <Snowflake
                ...
                isGold={isStep4Gold}
              />
              <span className={`text-xs font-semibold text-center transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] hover:transition-none ${isStep4Gold ? "text-[color:var(--sf-muted)]" : getTextColorClass(4)}`}>
          ...
          <div
            className={`mt-6 transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] ${
