...
export const AVAILABLE_VAULTS: VaultConfig[] = [
  {
    ...
    outputAsset: 'yvfrBTC',
    estimatedApy: '4.2',
    apyHistory: [3.8, 3.9, 3.9, 4.0, 3.9, 4.0, 4.0, 4.0, 4.1, 4.1, 4.0, 4.1, 4.1, 4.1, 4.2, 4.1, 4.2, 4.2, 4.2, 4.2, 4.1, 4.2, 4.2, 4.3, 4.2, 4.3, 4.3, 4.2, 4.3, 4.2],
    riskLevel: 'medium',
  ...
  },
  {
    ...
    outputAsset: 'veORDI',
    estimatedApy: '24',
    apyHistory: [21, 22, 22, 22, 21, 22, 22, 23, 23, 22, 23, 23, 23, 24, 24, 23, 24, 24, 24, 24, 25, 24, 25, 25, 24, 25, 25, 25, 24, 24],
    riskLevel: 'very-high',
    hasBoost: true,
  ...
  },
  {
    ...
    outputAsset: 'veUSD',
    estimatedApy: '3.8',
    apyHistory: [3.4, 3.5, 3.5, 3.5, 3.4, 3.5, 3.6, 3.6, 3.6, 3.6, 3.5, 3.6, 3.6, 3.7, 3.7, 3.7, 3.7, 3.6, 3.7, 3.8, 3.8, 3.8, 3.7, 3.8, 3.8, 3.9, 3.8, 3.9, 3.9, 3.8],
    riskLevel: 'low',
    hasBoost: true,
  ...
  },
  {
    ...
    outputAsset: 'dxBTC',
    estimatedApy: '5.2',
    apyHistory: [4.8, 4.8, 4.9, 4.9, 5.0, 4.9, 5.0, 5.0, 5.0, 5.1, 5.0, 5.1, 5.1, 5.1, 5.1, 5.2, 5.1, 5.2, 5.2, 5.2, 5.2, 5.1, 5.2, 5.3, 5.3, 5.2, 5.3, 5.3, 5.3, 5.2],
    riskLevel: 'medium',
    hasBoost: true,
