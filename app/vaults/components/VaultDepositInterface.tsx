...
export default function VaultDepositInterface({
  ...
  return (
    <div className="rounded-2xl bg-[color:var(--sf-glass-bg)] p-6 sm:p-9 shadow-[0_4px_20px_rgba(0,0,0,0.2)] backdrop-blur-md">
      {/* Tabs */}
      ...
      {mode === 'deposit' ? (
        ...
        <div className="relative flex flex-col gap-3">
          ...
          {/* Miner Fee Section */}
          <div className="relative z-[5] rounded-xl bg-[color:var(--sf-surface)]/40 p-4 backdrop-blur-sm">
            <div>
