    ...
    <div className="rounded-xl bg-[color:var(--sf-surface)]/60 p-6 backdrop-blur-sm sticky top-4">
        ...
        {showDepositWithdraw && (
          <>
            <button
              ...
              className={`flex-1 rounded-lg px-4 py-2 text-sm font-semibold transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] hover:transition-none ${
                mode === 'deposit'
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 h-12 rounded-lg bg-gray-100 hover:bg-gray-200 text-sm font-semibold text-gray-700 transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] hover:transition-none"
          >
            MAX
          </button>
        </div>
      ...
      {onClaim && parseFloat(pendingRewards) > 0 && (
        <div className="pt-4 border-t border-[color:var(--sf-outline)]">
          ...
          <button
            onClick={onClaim}
            className="w-full rounded-lg bg-green-500 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-[600ms] ease-[cubic-bezier(0,0,0,1)] hover:transition-none hover:bg-green-600"
          >
            CLAIM REWARDS
          </button>
        </div>
