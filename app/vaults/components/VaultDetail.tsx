    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6 md:space-y-0">
        ...
        <div className="hidden md:grid md:grid-cols-2 md:gap-6 md:items-start">
          ...
          <div className={`rounded-xl border border-[color:var(--sf-outline)] bg-white/60 p-6 backdrop-blur-sm h-fit md:col-start-2 ${currentVault.isBoostComingSoon ? 'md:row-start-4' : 'md:row-start-3'}`}>
