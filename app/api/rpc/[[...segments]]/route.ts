...
export async function POST(
  ...
  try {
    ...
    // because the in-process WASM indexer lives only in the browser's fetch
    // interceptor. regtest-local however is a real Docker / SSH-tunneled
    // service at localhost:18888 that the Next.js server CAN reach — do NOT
    // block it here.
    if (network === 'devnet') {
